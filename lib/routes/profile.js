...
module.exports = router
  ...
  .put('/profile/friends/:id', (req, res) => {
  ...
  .put('/profile/friends/:id/confirm', (req, res) => {
    return User.findByIdAndUpdate(req.params.id, {
  ...
  .get('/profile/friends/:id', (req, res) => {
    User.findById(req.params.id)
      .lean()
  ...
  // add a new Shareable
  .post('/profile/shareables', (req, res) => {
  ...
  .get('/profile/shareables', (req, res) => {
    User.findById(req.params.id)
      .populate('shareables')
      .lean()
  ...
  .get('/profile/shareables/:id', (req, res) => {
  ...
  .put('/profile/shareables/:id', (req, res) => {
  ...
  .delete('/profile/shareables/:id', (req, res) => {
  ...
  // expects the ID OF THE USER as the id PROPERTY ON THE BODY
  .delete('/profile/friends/:id', (req, res) => {
    Shareable.findByIdAndRemove(req.params.id)
      .then(() => {
        return User.findByIdAndUpdate(req.body.id, {
