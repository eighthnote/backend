...
module.exports = router
  ...
  .put('/friends', ensureAuth, (req, res) => {
    ...
    return User.findOne(query)
      ...
      .then(result => {
        ...
        result.friends.forEach((friend) => {
          friend._id.toString() === req.account.id ? alreadyFriend = true : null;
        });
  ...
  .put('/friends/confirm/:id', ensureAuth, (req, res) => {
  ...
  .get('/friends', ensureAuth, (req, res) => {
    User.findById(req.account.id)
  ...
  .get('/friends/:id', ensureAuth, (req, res) => {
    User.findById(req.account.id)
      .populate('friends')
      .then((body) => {
  ...
  .post('/shareables', ensureAuth, (req, res) => {
  ...
  .get('/shareables', ensureAuth, (req, res) => {
    User.findById(req.account.id)
      .populate('shareables')
      .lean()
  ...
  .put('/shareables/:id', ensureAuth, (req, res) => {
  ...
  .delete('/shareables/:id', ensureAuth, (req, res) => {
    return User.findById(req.account.id)
      .populate('shareables')
      .then((body) => {
        body.shareables.forEach((shareable) => {
  ...
  .delete('/friends/:id', ensureAuth, (req, res) => {
